...
namespace RawInput_dll
{
    static public class Win32
    {
       ...
       public const int GF_END = 0x00000004;
        ...
        public static bool FoundTouchScreen { get; private set; }
        public static TouchDevice TouchDevice { get; private set; }
        ...
        [DllImport("User32.dll", SetLastError = true)]
        internal static extern int GetRawInputBuffer([Out] out RawInput2 data, [In, Out] ref int size, int sizeHeader);
        ...
        [DllImport("user32")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool GetPointerDeviceRects(IntPtr hDevice, ref Rect pointerDeviceRect, ref Rect displayRect);
        ...
        public static void DeviceAudit()
        {
            ...
            if (GetRawInputDeviceList(IntPtr.Zero, ref deviceCount, (uint)dwSize) == 0)
            {
                ...
                for (var i = 0; i < deviceCount; i++)
                {
                    ...
                    {
                        if ((ushort)HidUsagePage.Digitizer == di.HIDInfo.UsagePage && ((ushort)HidUsage.Joystick)== di.HIDInfo.Usage)
                        {
                            ...
                            // Find the device rects
                            GetPointerDeviceRects(rid.hDevice, ref pointerRect, ref displayRect);

                            TouchDevice.DeviceInfo = di.HIDInfo;
                            TouchDevice.ProductId = di.HIDInfo.ProductID;
                            TouchDevice.VendorId = di.HIDInfo.VendorID;
                            TouchDevice.Width = pointerRect.Width;
