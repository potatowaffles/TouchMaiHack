...
namespace RawInput_dll
{
    ...
    public enum HidUsagePage : ushort
    {
        ...
        LED = 0x08,             // LED controls.
        Button = 0x09,          // Button.
        Ordinal = 0x0A,         // Ordinal.
        Telephony = 0x0B,       // Telephony.
        Consumer = 0x0C,        // Consumer.
        Digitizer = 0x0D,       // Digitizer.
        PID = 0x0F,             // Physical interface device.
        Unicode = 0x10,         // Unicode
        AlphaNumeric = 0x14,    // Alphanumeric display.
        Medical = 0x40,         // Medical instruments.
        MonitorPage0 = 0x80,    // Monitor page 0.
        MonitorPage1 = 0x81,    // Monitor page 1.
        MonitorPage2 = 0x82,    // Monitor page 2.
        MonitorPage3 = 0x83,    // Monitor page 3.
        PowerPage0 = 0x84,      // Power page 0.
        PowerPage1 = 0x85,      // Power page 1.
        PowerPage2 = 0x86,      // Power page 2.
        PowerPage3 = 0x87,      // Power page 3.
        BarCode = 0x8C,         // Bar code scanner.
        Scale = 0x8D,           // Scale page.
        MSR = 0x8E              // Magnetic strip reading devices.
    }
